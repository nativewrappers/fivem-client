...
export class Vector4 implements Vec4 {
  ...
  public static add(v1: Vec4, v2: Vec4 | number): Vector4 {
    if (typeof v2 === 'number') return new Vector4(v1.x + v2, v1.y + v2, v1.z + v2, v1.w + v2);
    return new Vector4(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z, v1.w + v2.w);
  }

  public static subtract(v1: Vec4, v2: Vec4 | number): Vector4 {
    if (typeof v2 === 'number') return new Vector4(v1.x - v2, v1.y - v2, v1.z - v2, v1.w - v2);
    return new Vector4(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z, v1.w - v2.w);
  }
  ...
  public static crossProduct(v1: Vec4, v2: Vec4): Vector4 {
    const x = v1.y * v2.z - v1.z * v2.y;
    const y = v1.z * v2.x - v1.z * v2.z;
    const z = v1.x * v2.y - v1.z * v2.x;
    const w = v1.y * v2.x - v1.z * v2.y;
  ...
  public crossProduct(v: Vec4): Vector4 {
  ...
  public add(v: Vec4 | number): Vec4 {
    return Vector4.add(this, v);
  }

  public subtract(v: Vec4 | number): Vector4 {
    return Vector4.subtract(this, v);
  }

  public multiply(v: Vec4 | number): Vector4 {
    return Vector4.multiply(this, v);
  }

  public divide(v: Vec4 | number): Vec4 {
