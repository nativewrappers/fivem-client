...
export class Vector3 implements Vec3 {
	...
	public static add(v1: Vec3, v2: Vec3 | Vector3 | number): Vector3 {
		if (typeof v2 === 'number') return new Vector3(v1.x + v2, v1.y + v2, v1.z + v2);
		return new Vector3(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z);
	}

	public static subtract(v1: Vec3 | Vector3, v2: Vec3 | Vector3 | number): Vector3 {
		if (typeof v2 === 'number') return new Vector3(v1.x - v2, v1.y - v2, v1.z - v2);
		return new Vector3(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
	}
	...
	public multiply(v: Vec3 | Vector3 | number): Vector3 {
